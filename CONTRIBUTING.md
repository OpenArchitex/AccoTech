...
- If you have any issue please report that using [GitHub Issues](https://github.com/OpenArchitex/AccoTech/issues). 
...
- All coding contributions should be done through [pull requests](https://help.github.com/en/articles/creating-a-pull-request-from-a-fork). We do not respond to emails or coding posted via our Gitter channel. If you have any suggessions or want to contribute please open a [issue](https://github.com/OpenArchitex/AccoTech/issues) first. This way we could discuss about the change and once finalized you could do a pull request. 

- Also please make sure your tests pass the [Sonar](https://sonarcloud.io/dashboard?id=OpenArchitex_AccoTech) quality
...
an issue in our [issue tracker](https://github.com/OpenArchitex/AccoTech/issues). :snowman:
